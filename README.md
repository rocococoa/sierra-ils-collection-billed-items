# Sierra ILS Collection - Billed Items Automated Report
...
**Impact:** Empowers collection development librarians by automatically delivering scheduled report, every 30 days, that include actionable insights on items to consider for repurchase.
